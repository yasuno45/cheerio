// original file is domparser on npm(https://npmjs.org/package/domparser) by jin_preserved

var htmlparser = require('htmlparser2');
var ElementType = htmlparser.ElementType;
...
DomHandler.prototype.onopentag = function(name, attribs){
    ...
    if(lastTag){
        ...
        // If the tag is not closed brother, forcibly closed pattern
        if ((lastTag.name === 'dt' || lastTag.name === 'dd') && (name === 'dt' || name === 'dd'))
        {
            this.onclosetag(lastTag.name);

            // replace the parent does not get lastTag
